            ...
            for t in diccionario:
                if t.y==i and t.x==x1:
                    if t.val==46:
                        ...
                        t.val=43
                    elif t.val==92 or t.val==47 or t.val==88:
                        t.val=42
    #ir a la izquierda
    if y1>y2 and x1==x2:
...
# number_of_lines = len(multiline_string.splitlines())
# new_string = string.strip(" ")
# new_string = string.lstrip().rstrip(" ")
# new_string = string.rstrip(" ", " ")


for i in range(len(solucion.splitlines())):
    print(solucion.splitlines()[i].rstrip(" "))